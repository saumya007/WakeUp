...
public class SnoozeAndStopAnimation extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snooze_and_stop_animation);
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener{
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if(e1.getX()-e2.getX()>SWIPE_MIN_DISTANCE && Math.abs(velocityX)>SWIPE_THRESHOLD_VELOCITY){
                ...
                Intent i = new Intent(SnoozeAndStopAnimation.this,SnoozeActivity.class);
                i.putExtra("Uri",uri);
                startActivity(i);
                finish();
            }
                ...
                Intent i = new Intent(SnoozeAndStopAnimation.this,DismissActivity.class);
                startActivity(i);
                finish();
                //Toast.makeText(getApplicationContext(), "Right TO Left", Toast.LENGTH_SHORT).show();
